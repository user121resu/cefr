...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    public ResponseEntity<AuthenticationResponse> register(RegisterRequest request) {
        ...
        Role role = roleRepository.save(new Role(null, "ROLE_SPEAKER"));
        User user = User
                .builder()
        ...
        return ResponseEntity.ok(AuthenticationResponse.builder().token(jwtService.generateToken(user)).user(userMapper.toDto(user)).build());
    }
